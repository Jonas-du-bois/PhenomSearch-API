    ...
    paths: {
      '/sightings/all': {
        get: {
          ...
          description: 'Retourne la liste complète des observations sans pagination. ⚠️ Attention: ce endpoint retourne un grand volume de données (~18000 observations). Utilisez les filtres pour réduire le volume si nécessaire.',
          parameters: [
            {
              name: 'country',
              in: 'query',
          ...
          responses: {
            '200': {
              description: 'Liste complète des observations',
              content: {
                'application/json': {
                  schema: {
                    type: 'object',
                    properties: {
                      ...
                      meta: {
                        ...
                        properties: {
                          ...
                          warning: { type: 'string', nullable: true, example: 'Large dataset - consider using pagination for better performance' }
                        }
                      }
                    }
                  }
